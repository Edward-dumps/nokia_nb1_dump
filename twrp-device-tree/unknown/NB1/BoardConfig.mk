...
DEVICE_PATH := device/unknown/NB1
...
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 53735424 # This is the maximum known partition size, but it can be higher, so we just omit it
...
TARGET_KERNEL_SOURCE := kernel/unknown/NB1
